 ...
 */
class Chat extends \AppBundle\Entity\Chat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Chat' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Chat' . "\0" . 'from', '' . "\0" . 'AppBundle\\Entity\\Chat' . "\0" . 'to', '' . "\0" . 'AppBundle\\Entity\\Chat' . "\0" . 'message', '' . "\0" . 'AppBundle\\Entity\\Chat' . "\0" . 'sent', '' . "\0" . 'AppBundle\\Entity\\Chat' . "\0" . 'recd');
        }
    ...
    public function setRecd($recd)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRecd', array($recd));

        return parent::setRecd($recd);
    }
    ...
    public function getRecd()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRecd', array());

        return parent::getRecd();
    }
