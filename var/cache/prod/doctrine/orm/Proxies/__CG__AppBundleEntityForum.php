 ...
 */
class Forum extends \AppBundle\Entity\Forum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Forum' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Forum' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Forum' . "\0" . 'userId', '' . "\0" . 'AppBundle\\Entity\\Forum' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\Forum' . "\0" . 'userLogin');
        }
